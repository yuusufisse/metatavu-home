...
import { Modal, Box, Typography, TextField, Button, Grid, Chip, IconButton, Autocomplete } from '@mui/material';
        ...
        <Grid container spacing={2} sx={{ flexGrow: 1 }}>
          <Grid item xs={12} md={6}>
            <TextField
              ...
              required
              error={nameExists}
              helperText={nameExists ? 'This name already exists.' : strings.softwareRegistry.nameRequired}
            />
          </Grid>
          <Grid item xs={12} md={6}>
            <TextField
