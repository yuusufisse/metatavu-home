...
import { fromMonToFri, fromMonToFriNotMonWed, fromMonToFriNotWed, nonWeeekWorker, oneDayWorker } from "../mock/working-weeks-mock";
import { describe, expect, test } from '@jest/globals';
import { fullTimeWorkerTestCases, nonWeeekWorkerTestCases, oneDayWorkerTestCases, partTimeWorkerNotMonWedTestCases, partTimeWorkerNotWedTestCases } from "../mock/test-cases";
